        ...
        <div class="max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-full lg:px-12 mx-auto">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    ...
                    <h1 class="text-lg font-semibold leading-6 text-gray-700">Partners</h1>
                            ...
                            @foreach($partners as $partner)
                                <tr>
                                    ...
                                    <td class="relative py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                        <a href="{{ route('admin.partner.edit', ['partner' => $partner->id]) }}" class="text-indigo-600 hover:text-indigo-900">
    ...
    <!-- <div id="myModal" class="hidden fixed z-10 inset-0 overflow-y-auto shadow-2xl"> -->
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded p-8 shadow-2xl">
                <!-- Modal content -->
                <h2 class="mb-2 text-base font-semibold text-gray-900">Are you sure you want to delete this partner?</h2>
