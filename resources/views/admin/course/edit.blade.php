                    ...
                    <div class="mt-8 space-y-6">
                        <div class="w-full">
                            ...
                            @if($course->requirements_en != null)
                                ...
                                <div class="mt-2">
                                    <textarea rows="3" name="requirements_en[]" class="form-input w-full" placeholder="Requirement">{{ $requirement }}</textarea>
                        ...
                        <div class="w-full text-right">
                            ...
                            @if($course->requirements_ar != null)
                                ...
                                <div class="mt-2">
                                    <textarea rows="3" name="requirements_ar[]" class="form-input w-full placeholder:text-right text-right" style="direction: rtl;" placeholder="متطلب">{{ $requirement }}</textarea>
                                </div>
                                @endforeach
                            @else
                                <div class="mb-2">
