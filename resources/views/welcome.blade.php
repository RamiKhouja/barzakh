<x-app-layout>
    ...
    <div class="bg-primary-100 dark:bg-gray-700 w-full">
        ...
        <div class="flex justify-center">
            ...
            <div class="sm:px-6 lg:px-8 my-8 py-8 text-center max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-3xl">
                ...
                <p class="{{$lang=='ar' ? ('text-xl') : ('text-2xl lg:text-3xl')}} text-bordo tracking-wider leading-10 dark:text-primary-100" 
                    style="font-family:{{$lang=='ar' ? ('Noto Nastaliq Urdu') : ('Great Vibes')}} ; line-height: {{$lang=='ar' ? ('50px') : ('40px')}} " 
                    dir="{{$lang=='ar' ? ('rtl') : ('ltr')}}">
                    {{__('welcome.Charter-content')}}
                </p>
                <p class="{{$lang=='ar' ? ('text-xl') : ('text-2xl lg:text-3xl')}} mt-5 text-bordo dark:text-primary-100" style="font-family:{{$lang=='ar' ? ('Noto Nastaliq Urdu') : ('Great Vibes')}}" >
        ...
        <div id="courses" class="max-w-xs sm:max-w-xl md:max-w-xl lg:max-w-3xl mx-auto py-32 ">
            ...
            <div class="flex justify-center">
                <p class="{{$lang=='ar' ? ('text-3xl lg:text-4xl') : ('text-2xl lg:text-3xl')}} text-bordo dark:text-primary-50 font-medium mb-16" style="font-family:{{$lang=='ar' ? ('Noto Nastaliq Urdu') : ('Great Vibes')}}">
                ...
                <a href="{{ route('fields.showUrl', ['url' => $field->url]) }}" style="-webkit-tap-highlight-color: transparent;">
                    <div class="h-72 w-72 md:h-52 md:w-52 lg:h-72 lg:w-72 my-6 md:my-0 cat-circle hover:shadow-lg rounded-full">  
                        <div class="h-2/5 flex items-center justify-center text-center">
                            <div class="w-48">
                                <p class="{{$lang=='ar' ? ('text-xl md:text-sm lg:text-2xl font-semibold') : ('text-2xl md:text-xl lg:text-2xl font-medium')}} text-bordo" style="font-family:{{$lang=='ar' ? ('Noto Nastaliq Urdu') : ('Great Vibes')}}">
                                    {{ $field->title }}
                                </p>
                            </div>
                        </div>
            ...
            <div class="md:grid md:gap-8 xl:gap-16 md:grid-cols-2">
                <div class="w-full relative shadow-lg rounded-3xl mb-8 md:mb-0">
                    ...
                    <div class="absolute top-2 px-4 sm:px-6 md:px-4 lg:top-4 lg:px-6 xl:px-8 text-center">
                        <p class="text-2xl lg:text-3xl text-white font-semibold text-center" style="font-family:{{$lang=='ar' ? ('Noto Nastaliq Urdu') : ('Great Vibes')}}">
        ...
        <div id="partners" class="flex justify-center pb-32 pt-16">
            <a href="/services" class="group">
                <img src="{{ asset( 'pictures/global/labs-black.png') }}" class="h-28 sm:h-36 dark:hidden group-hover:hidden mr-4 md:mr-12" alt=""/>
                <img src="{{ asset( 'pictures/global/labs-red.png') }}" class="h-28 sm:h-36 hidden group-hover:block mr-4 md:mr-12" alt=""/>
                <img src="{{ asset( 'pictures/global/labs-white.png') }}" class="h-28 sm:h-36 mr-4 md:mr-12 hidden dark:block group-hover:dark:hidden" alt=""/>
            </a>
            <a href="#" class="group">
                <img src="{{ asset( 'pictures/global/store-black.png') }}" class="h-32 sm:h-36 dark:hidden group-hover:hidden ml-4 md:ml-12" alt=""/>
                <img src="{{ asset( 'pictures/global/store-red.png') }}" class="h-32 sm:h-36 hidden group-hover:block ml-4 md:ml-12" alt=""/>
                <img src="{{ asset( 'pictures/global/store-white.png') }}" class="h-32 sm:h-36 ml-4 md:ml-12 hidden dark:block group-hover:dark:hidden" alt=""/>
            </a>
        </div>
        <x-footer/>
    </div>
